...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  INDEX `fk_orders_shipping_address1_idx` (`shipping_address_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `payments_received` (
  `idpayments_received` INT NOT NULL AUTO_INCREMENT,
  ...
  `payment_methods_payment_method_id` INT NOT NULL,
  PRIMARY KEY (`idpayments_received`),
...
CREATE TABLE IF NOT EXISTS `restock_requests` (
  ...
  `request_date` TIMESTAMP NOT NULL DEFAULT pending,
